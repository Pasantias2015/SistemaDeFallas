  ...
  <div class='sidebar-1'> 
    ...
    <div class='sidebar-menu' ><i class="fa fa-folder-open-o left"></i>Reportes<div class='expand'><i class="fa fa-angle-left"></i></div></div>
      ...
      <ul>
        ...
        <a href="{{ url('rp1') }}"><li>Reporte Mto Preventivo: Fluidos Usados - Sustitución</li></a>
        <a href="{{ url('rp2') }}"><li>Reporte Mto Preventivo: Mantenimiento Motor</li></a>
      </ul>
      </div>
    <div class='sidebar-menu'><i class="fa fa-pencil-square-o left"></i>Mantenimientos Diario<div class='expand'><i class="fa fa-angle-left"></i></div></div>
      ...
      <div class='sub-menu'>
        <ul>
            <a href="{{ url('semanal') }}"><li>Mantenimiento Semanal</li></a>
            <a href="{{ url('mensual') }}"><li>Mantenimiento Mensual</li></a>
            <a href="{{ url('porfalla') }}"><li>Mantenimiento Por Falla</li></a>
        </ul>
      </div>
